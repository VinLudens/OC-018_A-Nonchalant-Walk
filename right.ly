...
right = \relative c'' {
  ...
  \once\override Beam.positions = #'(1.5 . 10) \tuplet 15/8 { a[ cis e f \change Staff = "right" \stemDown a cis e f \change Staff = "left" \stemUp \once\override Staff.Clef.X-extent = #'(0 . 3.3) \clef "treble" a cis e f \change Staff = "right" \stemDown a cis e] }
  ...
  g4)
  \cadenzaOn\small
  \once\override Beam.positions = #'(3 . 8) \tuplet 15/8 { \stemUp b16[ dis fis g \change Staff = "right" \stemDown b dis fis g \change Staff = "left" \stemUp \once\override Staff.Clef.X-extent = #'(0 . 3.6) \clef "treble" b dis fis g \change Staff = "right" \stemDown b dis fis] }
  ...
  \once\override Beam.positions = #'(3 . 6) \tuplet 12/8 { b[ dis fis g \change Staff = "right" \stemDown b dis fis g \change Staff = "left" \stemUp \once\override Staff.Clef.X-extent = #'(0 . 1.7) \clef "treble" b dis fis g] }
